...
_VERSION = 4  #: Protocol version (int)
_HEADER_BASE_V3 = 8   #: v3 header: magic(4) + ver(1) + flags_u8(1) + dtype(1) + ndim(1)
_HEADER_BASE_V4 = 10  #: v4 header: magic(4) + ver(1) + flags_u16(2) + dtype(1) + ndim(1) + reserved(1)
